...
namespace Easy.IO
{
    public interface BufferedSource : BufferedSource<BufferedSource>
    {
    }

    public interface BufferedSource<T> : Source
    {
        ...
        string ReadString(Encoding charset);

        /**
         * Removes {@code byteCount} bytes from this, decodes them as {@code charset}, and returns the
         * string.
         */
        string ReadString(long byteCount, Encoding charset);
